...
<head>
    ...
    <style>
        * { box-sizing: border-box; }
        ...
        .sidebar-brand h4 { color: white; font-weight: 700; margin: 0; font-size: 1.3rem; }
...
<body>
                ...
                <form action="" method="post" id="text-editor">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="title" id="titleInput"
                               ...
                               value="<?= esc($post['title']) ?>" required maxlength="100">
    ...
    <script>
        ...
        // Isi counter saat halaman load
        charCount.textContent = titleInput.value.length + ' / 100 karakter';
